...
$scope.bookget = function () {        document.getElementById("Content").innerHTML = '<object type="text/html" data="https://joelle.domains.trincoll.edu/pnewbooks.html" style="width:100%" id="bookbox";>New books visual display</object>';    };    
$scope.bookget();
}]);